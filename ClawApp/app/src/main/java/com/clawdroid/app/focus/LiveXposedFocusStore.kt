...
import com.clawdroid.app.xposed.XposedFocusSnapshotStore
import java.util.concurrent.CopyOnWriteArraySet

/**
 * Process-scoped cache of the latest Xposed focus snapshot pushed via ContentProvider.
 * Mirrors [com.clawdroid.app.tools.LiveToolCapabilityStore].
 */
object LiveXposedFocusStore {
    @Volatile
    ...
    fun summaryForProbe(): String {
        ...
        return XposedFocusSnapshotStore.formatSummary(raw)
    }
    ...
    fun updateFromJson(json: String): Boolean {
        ...
        val summary = XposedFocusSnapshotStore.formatSummary(trimmed)
